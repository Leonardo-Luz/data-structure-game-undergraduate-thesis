...
\chapter{Requisitos não funcionais} \label{apd:nrf}

Este apêndice documenta todos os requisitos não-funcionais identificados durante a fase de análise da metodologia ENgAGED.
Os requisitos não-funcionais especificam características de qualidade, restrições técnicas e atributos de desempenho que o sistema deve atender.

Cada requisito é identificado por um código único (NFR-XX), possui um nome descritivo, uma categoria de qualidade e uma descrição detalhada de seus critérios de aceitação.
