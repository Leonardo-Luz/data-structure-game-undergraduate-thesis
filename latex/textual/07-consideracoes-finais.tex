...
\cite{coffey2009digital}, a concepção dos elementos do jogo e o desenvolvimento
das mecânicas centrais e genéricas.
...
\begin{itemize}
    ...
    \item \textbf{Validação Metodológica:} A avaliação realizou-se em caráter
      ...
      pedagógica.
    \item \textbf{Aspectos Técnicos:} A geração aleatória de
      elementos\footnote{Funcionalidade relacionada ao gerador de números
      aleatórios (RNG)}, apresentou problemas de balanceamento, ocasionalmente
      criando situações de travamento que frustraram os jogadores.
\end{itemize}
...
\input{tables/trabalhos-futuros-incompletos}
...
\input{tables/trabalhos-futuros-feedback}
...
\input{tables/trabalhos-futuros-ideias}
...
diferenciando-se das abordagens tradicionais baseadas em \emph{puzzles} ou
questionários gamificados.
...
sido identificadas, elas não invalidam o modelo educativo proposto. Pelo
contrário, apontam caminhos claros para o refinamento da ferramenta. Assim,
conclui-se que o projeto entrega uma contribuição relevante ao fugir dos
modelos convencionais de jogos educativos, indicando que o gênero plataforma 2D
possui potencial para apoiar o ensino de estrutura de dados. O jogo estabelece,
