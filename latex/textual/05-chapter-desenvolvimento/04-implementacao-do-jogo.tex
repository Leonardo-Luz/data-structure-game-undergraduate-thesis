...
\textbf{Unity}. Inicialmente, são contextualizados os principais conceitos
técnicos da \emph{engine} utilizados como base para a construção dos sistemas
implementados. Em seguida, \fixme{ descrevem-se os principais elementos
  listados na \autoref{tab:elementos_jogo} e discute-se como as mecânicas
  centrais e genéricas, definidas nas \autoref{tab:mecanicas_centrais} e
...
Além dos sistemas principais, diversos outros \emph{scripts} foram implementados
para garantir um \emph{gameplay} fluido, estável e responsivo. Entre eles,
incluem-se módulos para controle de efeitos sonoros, partículas, interface de
...
componentes desempenham papel importante na polidez e na imersão da experiência.
