...
principal (\emph{master}), música e efeitos sonoros (SFX\footnote{\emph{Sound
Effects}}). Cada categoria pode ser ajustada individualmente, permitindo ao
jogador personalizar sua experiência sonora. Além disso, o controlador
centraliza a reprodução de sons contextuais do jogo, garantindo consistência e
