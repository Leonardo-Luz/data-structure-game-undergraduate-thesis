...
feedback educacional, estabelecendo as bases conceituais para o desenvolvimento
apresentado nas seções seguintes.

\subsection*{Objetivos do Jogo}

O Jogador tem como objetivo narrativo recuperar a sua pesquisa a respeito da
pedra filosofal

\subsubsection*{Gênero e Perspectiva}

O jogo é um \textbf{platformer 2D}\footnote{Gênero de jogo plataforma em duas dimensões} com
perspectiva \textit{side-scrolling}\footnote{Estilo de \emph{gameplay} onde o
jogador se move horizontalmente e a tela o segue.}. Essa escolha baseia-se na
familiaridade do público geral com clássicos como Super Mario Bros e Mega Man,
facilitando a adoção do jogo e tornando a experiência intuitiva.


\subsection*{Temática e Narrativa}

A narrativa é ambientada em um universo de \textbf{alquimia} mística e
medieval. O protagonista é um alquimista caracterizado como um doutor da peste
que teve sua pesquisa sobre a \textbf{pedra filosofal} roubada por um
alquimista rival enquanto viajava para a capital para apresentá-la ao Círculo
dos Alquimistas (Grupo de estudiosos importantes). Seu objetivo é recuperar a
...
\input{tables/mecanicas-centrais}
...
assegurando que o jogador tenha controle responsivo e feedbacks claros de suas
...
\input{tables/mecanicas-genericas}
...
fase, o jogo apresenta um \textbf{feedback somativo} por meio de um relatório
...
\subsection*{Feedback Educacional}
...
sonoros e um \textbf{feedback visual de erro}, evidenciado por mudanças de cor
...
Complementando esses retornos imediatos, o \textbf{feedback somativo}
