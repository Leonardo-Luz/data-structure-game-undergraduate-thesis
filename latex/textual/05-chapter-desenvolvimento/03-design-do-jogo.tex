...
\subsection{Definir \emph{Game Engine}}

Dentre as diversas \textit{game engines} disponíveis atualmente, realizou-se
uma análise comparativa considerando critérios como facilidade de uso,
...
\textbf{Unreal Engine} e \textbf{Unity}. Essas plataformas foram comparadas de
forma sistemática, a fim de identificar quais de suas características melhor se
alinhavam às demandas do jogo proposto, conforme apresentado na
\autoref{tab:comparativo_engines}.
...
principais elementos do cenário e familiarizar-se com a proposta do jogo. A
\autoref{fig:level_inicial} demonstra a modelagem deste nível, definindo a
posição de cada elemento do jogo.
