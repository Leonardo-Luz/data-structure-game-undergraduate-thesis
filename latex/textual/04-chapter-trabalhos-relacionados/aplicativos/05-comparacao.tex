...
\begin{itemize}
  \item \textbf{Conceitos de Estrutura de Dados (CED)}: Quais conceitos foram abordados: Pilha (P), Fila (F), Lista (L).
...
registradas, a avaliação é considerada \textbf{indefinida}.
...
O cálculo utilizado para a conversão é dado pela \autoref{eq:avaliacao_conversao}

\begin{equation}
\text{Porcentagem de Avaliações Positivas} \times \frac{5}{100}
\label{eq:avaliacao_conversao}
\end{equation}
