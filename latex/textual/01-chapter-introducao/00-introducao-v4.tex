...
ocorre por meio de aulas expositivas, o que tende a gerar baixa retenção do
conteúdo e desinteresse por parte dos estudantes \cite{chilwant2012comparison}.
...
comportamento que valoriza respostas rápidas e estímulos visuais
\cite{ha2020role}. Isso torna o ensino convencional ainda menos atrativo. A
partir de sua pesquisa, o autor \citeonline{mtaho2024difficulties} recomenda a
adoção de novas estratégias de ensino para mitigar as dificuldades e melhorar a
experiência de aprendizagem de estrutura de dados.

Nesse cenário, os jogos sérios surgem como uma estratégia educacional
promissora, ao promover o aprendizado ativo e engajado
\cite{mouaheb2012serious}. Diferentemente de abordagens instrucionais diretas,
os jogos sérios podem ser projetados para que a aprendizagem ocorra como
consequência da interação do jogador com o ambiente, desafios e regras do jogo.
Essa perspectiva está alinhada à teoria do construcionismo, proposta por
\citeonline{papert1993mindstorms}, segundo a qual o conhecimento é construído
ativamente pelos alunos quando estes se envolvem com a criação, exploração e
manipulação de artefatos significativos.
...
que muitos desses jogos sérios falham como jogos, priorizam o conteúdo
educativo de forma explícita, relegando a experiência lúdica a segundo plano,
quando, na verdade, ensino e entretenimento deveriam caminhar lado a lado
\cite{mouaheb2012serious}.

De acordo com \citeonline{de2025codebo}, atualmente, grande parte dos jogos
sérios utilizam os conceitos de programação apenas como tema, sem integrá-los
...
mecânicas expositivas como questionários ou simulações superficiais.
