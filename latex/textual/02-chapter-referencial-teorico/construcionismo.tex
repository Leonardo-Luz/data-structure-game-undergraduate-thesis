...
Construcionismo de \citeonline{papert1993mindstorms}. Derivada do
construtivismo de Piaget, a teoria de Papert postula que a aprendizagem é mais
eficaz quando o aprendiz está conscientemente engajado na construção de um
artefato público e tangível, seja ele um castelo de areia, um poema, uma
máquina ou um programa de computador . Essa perspectiva é crucial para o
desenvolvimento de ambientes de aprendizagem que promovam a autonomia e a
descoberta.
...
trabalho pode ser visto como um \enquote{micromundo} de aprendizagem, um ambiente onde
